...
while(t--){
    ...
    ll lbc=lcm(b,c);
    ll lac=lcm(a,c);
    ll labc=lcm(a,lcm(b,c));
    
    ansa=(m/lab-m/labc)*3+(m/lac-m/labc)*3+(m/labc)*2+(m/a-m/lab-m/lac+m/labc)*6;
    ansb=(m/lab-m/labc)*3+(m/lbc-m/labc)*3+(m/labc)*2+(m/b-m/lab-m/lbc+m/labc)*6;
    ansc=(m/lbc-m/labc)*3+(m/lac-m/labc)*3+(m/labc)*2+(m/c-m/lbc-m/lac+m/labc)*6;
